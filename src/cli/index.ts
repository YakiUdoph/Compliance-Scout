...
function parseCsvFile(filePath: string): BusinessInput[] {
...
export async function runCli(): Promise<void> {
  ...
  try {
    ...
    console.error(`\x1b[31m❌ Error loading CSV dataset:\x1b[0m ${(error as Error).message}`);
    process.exit(1);
  }
